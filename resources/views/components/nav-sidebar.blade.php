@php
    $navItems = [
        ...
        ['label' => 'Contacts',  'route' => null, 'icon' => 'M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0'],
...
<aside
    class="fixed inset-y-0 left-0 z-40 flex w-64 flex-col -translate-x-full transform border-r border-gray-200 bg-white transition-transform duration-200 lg:static lg:translate-x-0"
    :class="sidebarOpen ? 'translate-x-0' : '-translate-x-full'"
>
    <div class="flex h-14 shrink-0 items-center justify-between border-b border-gray-200 px-4">
        <a href="{{ route('dashboard') }}" class="text-lg font-bold text-emerald-600">BartaFlow</a>
        <button @click="sidebarOpen = false" class="rounded p-1 text-gray-400 hover:bg-gray-100 lg:hidden" aria-label="Close menu">
    ...
    <nav class="flex-1 overflow-y-auto p-3 space-y-0.5">
        @foreach ($navItems as $item)
            ...
            <a
                ...
                @class([
                    ...
                    'cursor-default opacity-40'        => ! $item['route'],
                ])
            >
        ...
        <div class="pt-4 pb-1">
            <p class="px-3 text-xs font-semibold uppercase tracking-wider text-gray-400">Settings</p>
        </div>
